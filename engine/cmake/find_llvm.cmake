...
set(libclang_static_lib_name "libclang${CMAKE_STATIC_LIBRARY_SUFFIX}")

set(libclang_shared_lib_name "libclang${CMAKE_SHARED_LIBRARY_SUFFIX}")
...
if (NOT llvm_include_dirs OR NOT llvm_binary_dir OR (NOT llvm_library_dirs AND libclang_use_static_lib))
    message(SEND_ERROR
...
set(libclang_shared_library "${llvm_binary_dir}/${libclang_shared_lib_name}")

if (libclang_use_static_lib)
    set(libclang_library "${llvm_library_dirs}/${libclang_static_lib_name}")
else ()
